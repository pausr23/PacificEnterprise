<div class="fixed md:mr-5 hidden lg:block">
    ...
    <div id="sidebar-menu" class="hidden lg:grid pl-2 pt-6 text-white font-light text-xs 2xl:text-sm font-main">
        <a class="py-3 mb-3 2xl:mb-5 pl-2  hover:bg-[#323035] focus:bg-[#323035] active:bg-[#323035] hidden rounded-lg"
        ...
        <a class="py-3 mb-3 2xl:mb-5 pl-2 hidden rounded-lg hover:bg-[#323035] focus:bg-[#323035] active:bg-[#323035]"
