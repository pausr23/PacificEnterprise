...
@section('content')
    <!-- Main Container -->
    <div class="h-screen bg-gradient-to-r bg-[#CDA0CB] relative overflow-hidden">
                    ...
                    <form class="grid gap-6" action="{{ route('admin.login.submit') }}" method="POST">
                        ...
                        <div class="relative">
                            <input
                                ...
                                required
                            >
                            <svg class="absolute left-2 top-1/2 transform -translate-y-1/2 w-6 h-6 text-[#CDA0CB]" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        ...
                        <div class="relative">
                            ...
                            >
                            <!-- Candado SVG -->
                            <svg class="absolute left-2 top-1/2 transform -translate-y-1/2 w-6 h-6 text-[#CDA0CB]" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
