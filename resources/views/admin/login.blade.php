...
@section('content')
    ...
    <div class="grid md:grid-cols-2  h-screen place-items-center">
        ...
        <!-- Left Image Section -->
        <img class="mx-auto w-[65%] hidden md:block py-60" src="https://i.ibb.co/KX69vv5/Pacific-Enterprise.png" alt="Pacific-Enterprise" />

        <!-- Right Login Section -->
        <div class="md:grid place-items-center secondary-color w-full h-full">

        <img class="mx-auto my-20 block md:hidden w-[65%]" src="https://i.ibb.co/KX69vv5/Pacific-Enterprise.png" alt="Pacific-Enterprise" />
